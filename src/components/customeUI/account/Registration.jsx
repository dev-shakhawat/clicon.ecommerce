...
export default function Registration() {
  ...
  return (
    ...
    <form action="#">
      ...
      {/* name */}
      <div className="mt-5">
        <label htmlFor="name" className=" font-Public_Sans font-normal text-sm leading-5 text-[#191C1F]  ">Email Address</label>
        <input type="text" id='name' className='w-full h-[48px] border border-[#E2E5E7] rounded-[2px] outline-0 px-4 mt-2 ' />
      </div>
      ...
      <div className="mt-4 relative ">
        ...
        <input type="text" className='w-full h-[48px] border border-[#E2E5E7] rounded-[2px] outline-0 py-4 pl-4 pr-10 mt-2  ' />
    ...
    <button onClick={()=> dispatch(ActiveModalSet('login'))} type="button" className='w-full h-[48px] border border-[#FA8232] rounded-[2px] mt-3 font-Public_Sans font-bold text-sm leading-[48px] text-[#FA8232] uppercase cursor-pointer flex items-center justify-center gap-2'>
        <span>Sign in</span>
    </button>
